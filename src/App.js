      ...
      <Layout className={darkMode ? "dark-mode" : "light-mode"}>
        <Header id="header-bar" className={darkMode ? "dark-mode" : "light-mode"} title=" " scroll>
          <Navigation className={darkMode ? "dark-mode" : "light-mode"}>
            <NavLink to="/jodi-app" activeStyle={{ fontWeight: "bold", textDecoration: "line-through"}}><p>Home</p></NavLink>
            ...
            <NavLink to="/feed" activeStyle={{ fontWeight: "bold", textDecoration: "line-through"}}></NavLink>
            {/* <NavLink to="/contact" activeStyle={{ fontWeight: "bold", textDecoration: "line-through"}}><p>Contact</p></NavLink> */}
          </Navigation>
        </Header>
        <button id="toggle-light" className={darkMode ? "dark-mode" : "light-mode"} onClick={() => setDarkMode(prevMode => !prevMode)}>
